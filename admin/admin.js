...
const els = {
  ...
  mapPreviewFrame: document.getElementById("map-preview-frame"),
...
function updateMapPreview(slug){
  ...
  const src = clean ? publicUrlFor(clean, "mapa") : "";
  if (els.mapPreviewFrame) els.mapPreviewFrame.src = src || "about:blank";
  if (els.mapPreviewFrame) els.mapPreviewFrame.style.display = src ? "block" : "none";
  if (els.mapPreviewEmpty) els.mapPreviewEmpty.style.display = src ? "none" : "block";
}
